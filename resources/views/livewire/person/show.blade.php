<x-ui-page>
    ...
    <x-slot name="actionbar">
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            ['label' => 'Personen', 'href' => route('organization.persons.index')],
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="py-3 px-4 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            ...
                            <div class="text-sm font-medium text-[var(--ui-secondary)]">{{ $person->code }}</div>
                        </div>
                        <div class="py-3 px-4 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                        ...
                        <div class="py-3 px-4 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            ...
                            <div class="text-sm font-medium text-[var(--ui-secondary)]">{{ $person->created_at->format('d.m.Y H:i') }}</div>
                        </div>
                        <div class="py-3 px-4 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            <span class="text-xs text-[var(--ui-muted)]">Aktualisiert</span>
                            <div class="text-sm font-medium text-[var(--ui-secondary)]">{{ $person->updated_at->format('d.m.Y H:i') }}</div>
                        </div>
                    </div>
                </div>
            </div>
