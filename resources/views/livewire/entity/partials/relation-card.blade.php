{{-- Relation Card — wird für ausgehende und eingehende Beziehungen verwendet --}}
@php
...
<div class="rounded-lg border border-[var(--ui-border)]/60 bg-[var(--ui-surface)]">
    ...
    <div class="flex items-center justify-between p-4">
        <div class="flex-1 min-w-0">
            ...
            {{-- Schnittstellen-Badges (immer sichtbar) --}}
            @if($hasInterlinks)
        ...
        <div class="flex-shrink-0 ml-4 flex items-center gap-1">
            <x-ui-button
                variant="{{ $expandedRelationId === $relation->id ? 'primary-outline' : 'secondary-ghost' }}"
                size="sm"
    ...
    {{-- Schnittstellen-Verwaltung (expandiert) --}}
    @if($expandedRelationId === $relation->id)
        <div class="border-t border-[var(--ui-border)]/40 p-4 bg-[var(--ui-muted-5)]/50">
            <div class="mb-3">
                ...
                <p class="text-xs text-[var(--ui-muted)] mt-0.5">Konkrete Berührungspunkte dieser Beziehung: Verträge, Systeme, Datenflüsse, etc. Es können mehrere hinzugefügt werden.</p>
            </div>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <div class="flex-1">
                        <x-ui-input-text
                            ...
                            placeholder="z.B. Vertragsnr., System-URL, Kontext"
                            size="sm"
                        />
                    </div>
                    <x-ui-button
