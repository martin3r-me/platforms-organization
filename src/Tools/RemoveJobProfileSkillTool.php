...
class RemoveJobProfileSkillTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'organization.job_profile_skills.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /organization/job-profile-skills - Entfernt einen Skill von einem JobProfile.';
    }
    ...
    public function getMetadata(): array
    {
        return [
            'category'      => 'action',
            'tags'          => ['organization', 'job_profiles', 'skills', 'delete'],
            'read_only'     => false,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level'    => 'write',
