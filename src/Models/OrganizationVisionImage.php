...
/**
 * VisionImage (Zukunftsbild): konkretes Zielbild in einer FocusArea.
 *
 * entity_id wird beim Save aus focus_area.entity_id abgeleitet und
 * gespiegelt, damit direkte Entity-Queries ohne Join moeglich sind.
 */
class OrganizationVisionImage extends Model implements HasDisplayName
{
    use SoftDeletes, LogsActivity;

    protected $table = 'organization_vision_images';
