...
class ListPersonSoftSkillsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'organization.person_soft_skills.GET';
    }

    public function getDescription(): string
    {
        return 'GET /organization/person-soft-skills - Listet alle Soft-Skills einer Person.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $softSkills = $person->softSkills()->get();
    ...
    public function getMetadata(): array
    {
        return [
            'category'      => 'read',
            'tags'          => ['organization', 'persons', 'soft-skills'],
            'read_only'     => true,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level'    => 'safe',
