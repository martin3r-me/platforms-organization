...
class ListVsmFunctionsTool implements ToolContract, ToolMetadataContract
{
        ...
        return $this->mergeSchemas(
            ...
            [
                'properties' => [
                    ...
                    'scope_entity_id' => [
                        'type' => 'integer',
                        'description' => 'Optional: Filter nach scope_entity_id (null = global, id = entity-spezifisch).',
                    ],
                    'entity_id' => [
                        'type' => 'integer',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            if (isset($arguments['entity_id']) && $arguments['entity_id']) {
                ...
                return ToolResult::success([
                    'data' => $items->map(fn ($f) => [
                        ...
                        'code' => $f->code,
                        'name' => $f->name,
                        'scope_entity_id' => $f->scope_entity_id,
            ...
            $this->applyStandardFilters($q, $arguments, ['team_id', 'is_active', 'code', 'scope_entity_id', 'entity_id', 'created_at']);
