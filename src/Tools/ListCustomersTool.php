...
class ListCustomersTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'organization.customers.GET';
    }

    public function getDescription(): string
    {
        return 'GET /organization/customers - Listet aktive Kunden (code/name) aus dem Root/Elterteam des angegebenen Teams. Nutze dieses Tool bevor du customer_id an anderen Modulen setzt (IDs nie raten). Unterstützt filters/search/sort/limit/offset.';
    }
        ...
        return $this->mergeSchemas(
            ...
            [
                'properties' => [
                    ...
                    'is_active' => [
                        'type' => 'boolean',
                        'description' => 'Optional: aktive/inaktive Kunden. Default: true.',
                        'default' => true,
                    ],
                    'code' => [
                        'type' => 'string',
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Laden der Kunden: ' . $e->getMessage());
        }
    }
    ...
    public function getMetadata(): array
    {
        return [
            'category' => 'read',
            'tags' => ['organization', 'customers', 'lookup'],
            'read_only' => true,
            'requires_auth' => true,
            'requires_team' => true,
            'risk_level' => 'safe',
