<x-ui-page>
    ...
    <x-slot name="actionbar">
        <x-ui-page-actionbar :breadcrumbs="[
            ...
            ['label' => 'Kostenstellen', 'href' => route('organization.cost-centers.index')],
            ['label' => $costCenter->name ?? 'Details'],
        ]">
            @if($this->isDirty())
    ...
    <x-ui-page-container>
        ...
        <div class="space-y-6">
            ...
            {{-- Verknüpfte Objekte (polymorphe Links) --}}
            ...
            <div class="bg-white rounded-lg border border-[var(--ui-border)] p-6">
                ...
                <div class="text-sm text-[var(--ui-muted)]">
                    <p>Kostenstellen-Zuweisungen werden über das Dimensions-Framework (Dimension-Links) verwaltet.</p>
                </div>
            </div>
        </div>
    </x-ui-page-container>
