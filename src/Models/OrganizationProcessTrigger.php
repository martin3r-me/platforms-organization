...
class OrganizationProcessTrigger extends Model
{
    use SoftDeletes;

    protected $table = 'organization_process_triggers';
    ...
    {
        return $this->belongsTo(OrganizationProcess::class, 'source_process_id');
    }
