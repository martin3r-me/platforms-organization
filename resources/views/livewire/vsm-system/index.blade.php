<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar title="VSM Systeme" />
    </x-slot>
        ...
        <x-ui-page-sidebar title="Filter" width="w-80" :defaultOpen="true" side="left">
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <div class="space-y-2">
                        <x-ui-input-text name="search" wire:model.live="search" placeholder="Suche VSM Systeme..." class="w-full" size="sm" />
                        <x-ui-button variant="secondary" size="sm" wire:click="create" class="w-full justify-start">
                            @svg('heroicon-o-plus','w-4 h-4')
                            <span class="ml-2">Neues VSM System</span>
                        </x-ui-button>
                    </div>
                </div>
                <div>
    ...
    <!-- Create VSM System Modal -->
    <x-ui-modal
        wire:model="modalShow"
        size="lg"
    >
        <x-slot name="header">
            Neues VSM System erstellen
        </x-slot>
            ...
            <form wire:submit.prevent="store" class="space-y-4">
                <div class="grid grid-cols-1 gap-4">
                    <x-ui-input-text
                        ...
                        required
                        placeholder="Code des VSM Systems"
                    />
                    ...
                    <x-ui-input-text
                        ...
                        required
                        placeholder="Name des VSM Systems"
                    />
